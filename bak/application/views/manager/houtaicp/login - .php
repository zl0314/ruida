    ...
    <div class="panel-content" id="login-form">
      <form method='post' action="" class='form-condensed'>
        <table class='table table-form'>
          ...
          <tr>
            <th></th>
            <td><button type='submit' id='submit' class='btn btn-submit btn-primary'>登录</button></td>
          </tr>
        </table>
      </form>
    </div>
    <div id='demoUsers' class="panel-foot"> <span>如果您不是此系统的管理人员，请离开。否则会追究您的责任。</span> </div>
  </div>
</div>
<script>
$('#username').focus();
