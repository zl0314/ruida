lilv_array = new Array;
        ...
        function exc_zuhe(fmobj, v) {
            if (fmobj.name == "calc11") {
                if (v == 3) {
                    document.getElementById("calc11_zuhe").style.display = 'block';
                    ...
                    document.getElementById("sdlv_li").style.display = 'block';
                    document.getElementById("gjlv_li").style.display = 'block';
                    ...
                    document.getElementById("calc11_ctype").style.display = 'block';
                    ...
                    document.getElementById("singlelv_li").style.display = 'block';
                    if (v == 1) {
        ...
        function ext_loantotal(fmobj) {
            ...
            if (strRadiox == 3) { //判断是房贷计算 组合型
                ...
                //月还款
                var lilv_sd = fmobj.sdlv.value / 100; 
                var lilv_gjj = fmobj.gjlv.value / 100; 
                ...
                //--  商业贷款、公积金贷款
                var lilv = fmobj.singlelv.value / 100; 
