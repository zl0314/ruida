...
<div class="warp clearfix">
    ...
    <input type="hidden" name="parentid" value="<?php echo request_get('parentid');?>">
    <div class="lb_top">
        ...
        <div class="lb_top_3 clearfix">
            <div class="qh">
               ...
               <input type="hidden" name="area_id" id="house_area_id" value="<?php echo request_get('area_id') ?>">
                ...
                <dl class="erji" id="house_area" style="display:<?php if(!request_get('city_id') || request_get('city_id')  || request_get('area_id') || !request_get('area_id')){ echo 'none'; }else{ echo 'none'; } ?>">
